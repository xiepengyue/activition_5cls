...
class ConvLayer:
    ...
    def __init__(self, input_shape, n_size, n_filter, stride=1, activation='relu',
                 batch_normal=True, weight_decay=None, name='conv', padding='VALID'):
        # params
        self.input_shape = input_shape
        self.n_filter = n_filter
        self.activation = activation
        self.stride = stride
        self.batch_normal = batch_normal   #True or false
    ...
    def get_output(self, input):
        ...
        self.bn_out = tf.layers.batch_normalization(self.conv, training=self.batch_normal, name='%s_bn'%(self.name))


        self.hidden = self.bn_out + self.bias
